...
/* harmony export */   _timer: () => (/* binding */ _timer)
/* harmony export */ });
...
function showSelectedChat(chat) {
    ...
    try {
        alt1.overLayRect(appColor, chat.mainbox.rect.x, chat.mainbox.rect.y, chat.mainbox.rect.width, chat.mainbox.rect.height, 3000, 5);
    }
    catch (_a) { }
}
